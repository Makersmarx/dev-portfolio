...
function Intro(){
    return (
        <Panel className="bg-[url('https://img.freepik.com/free-vector/soft-triangular-shape-line-pattern-background_1409-1897.jpg')] bg-no-repeat bg-cover bg-center bg-fixed">
